...
def simpleAccuracy(request):
    if request.method=='POST':
        ...
        pcaPlot =fu.projectIn2D(fu,pdFrame,PCA(n_components=2),"PCA",URL_Model)
        LDAPlot=fu.projectIn2D(fu,pdFrame,LDA(n_components=2),"LDA",URL_Model)
        ...
        context={ 'URL_Model':URL_Model, 'pcaPlot':pcaPlot,'LDAPlot':LDAPlot,'modelNames': modelNames,'LDA_zipped': LDA_zipped,'PCA_zipped': PCA_zipped}
